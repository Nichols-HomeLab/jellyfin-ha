...
in-tree PostgreSQL provider. See
...
This fork adds a thin HA layer on top of Jellyfin 12.0:
...
Core integration hooks preserve catalog ownership, replica convergence, and playback recovery alongside upstream behavior.
