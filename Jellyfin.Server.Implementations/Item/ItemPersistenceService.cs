    ...
    public void DeleteItem(params IReadOnlyList<Guid> ids)
    {
        ...
        if (userDataToDetach.Length > 0)
        {
            ...
            var existingPlaceholderData = context.UserData
                .Where(e => e.ItemId == BaseItemRepository.PlaceholderId && affectedUsers.Contains(e.UserId))
                .AsEnumerable()
            ...
            var mergedUserData = userDataToDetach
                ...
                .Select(group => BaseItemRepository.MergeUserData(group, BaseItemRepository.PlaceholderId, date));
            ...
            await using (transaction.ConfigureAwait(false))
            {
                ...
                if (placeholderData.Length > 0)
                {
                    ...
                    var mergedUserData = placeholderData
                        ...
                        .GroupBy(e => new { e.UserId, e.CustomDataKey })
                        .Select(group => BaseItemRepository.MergeUserData(group, item.Id, retentionDate));
